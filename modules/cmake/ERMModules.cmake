...
macro(erm_module_setup)
	...
	# Parse options
	# ===========================================================================
	set(ERM_MODULE_OPTIONS STATIC SHARED EXECUTABLES)
	set(ERM_MODULE_ONE_VALUE_ARGS VERSION DESCRIPTION)
	set(ERM_MODULE_MULTI_VALUE_ARGS LANGUAGES PRIVATE_DEPS PUBLIC_DEPS INTERFACE_DEPS)
	...
	elseif(NOT ${PROJECT_NAME}_STATIC AND NOT ${PROJECT_NAME}_SHARED AND NOT ${PROJECT_NAME}_EXECUTABLES)
		message(FATAL_ERROR "When calling erm_module_setup at least one of [STATIC, SHARED, EXECUTABLES] needs to be specified")
	else()
	...
	# ===========================================================================
	set(ERM_MODULE_HEADER "#pragma once\n\n")
	string(APPEND ERM_MODULE_HEADER "")

	file(MAKE_DIRECTORY "${ERM_GENERATED_DIR}/${PROJECT_NAME}/common/erm/")
	file(WRITE "${ERM_GENERATED_DIR}/${PROJECT_NAME}/common/erm/${PROJECT_NAME}.h" "${ERM_MODULE_HEADER}")
