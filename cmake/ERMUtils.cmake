function(erm_setup_api)
	if(ERM_OPEN_GL)
		set(ERM_RENDERING_API_COMPILE_DEF "ERM_OPEN_GL" PARENT_SCOPE)
		find_package(OpenGL REQUIRED)
		set(ERM_RENDERING_API_LIB "${OPENGL_gl_LIBRARY}" PARENT_SCOPE)
		set(ERM_RAY_TRACING_ENABLED OFF CACHE BOOL "" FORCE)
	elseif(ERM_VULKAN)
		set(ERM_RENDERING_API_COMPILE_DEF "ERM_VULKAN" PARENT_SCOPE)
		find_package(Vulkan REQUIRED)
		set(ERM_RENDERING_API_LIB "${Vulkan_LIBRARIES}" PARENT_SCOPE)
		set(ERM_RENDERING_API_INCLUDE_DIR "${Vulkan_INCLUDE_DIR}" PARENT_SCOPE)
	elseif(ERM_DX12)
		set(ERM_RENDERING_API_COMPILE_DEF "ERM_DX12" PARENT_SCOPE)
		set(ERM_RAY_TRACING_ENABLED OFF CACHE BOOL "" FORCE)
	endif()
endfunction()
