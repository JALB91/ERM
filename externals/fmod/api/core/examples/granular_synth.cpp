...
const char* soundname[NUMSOUNDS] = {Common_MediaPath("c.ogg"), Common_MediaPath("d.ogg"), Common_MediaPath("e.ogg")};
#else
...
const char* soundname[NUMSOUNDS] = {Common_MediaPath("granular/truck_idle_off_01.wav"), Common_MediaPath("granular/truck_idle_off_02.wav"), Common_MediaPath("granular/truck_idle_off_03.wav"), Common_MediaPath("granular/truck_idle_off_04.wav"), Common_MediaPath("granular/truck_idle_off_05.wav"), Common_MediaPath("granular/truck_idle_off_06.wav")};
#endif
